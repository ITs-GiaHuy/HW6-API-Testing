...
function getPreconditionScript(targetName) {
    return [
    ...
    item: [
        {
            ...
            request: {
                method: "GET",
                header: [],
                url: {raw: "{{base_url}}/api/orders/my-orders", host: ["{{base_url}}"], path: ["api", "orders", "my-orders"]}
            },
            event: [
                {listen: "prerequest", script: {type: "text/javascript", exec: getPreconditionScript("get_my_orders")}},
                {listen: "test", script: {type: "text/javascript", exec: testScript}}
            ]
        },
        {
            ...
            request: {
                method: "GET",
                header: [],
                url: {raw: "{{base_url}}/api/orders/{{test_order_id}}", host: ["{{base_url}}"], path: ["api", "orders", "{{test_order_id}}"]}
            },
            event: [
                {listen: "prerequest", script: {type: "text/javascript", exec: getPreconditionScript("get_order_detail")}},
                {listen: "test", script: {type: "text/javascript", exec: testScript}}
            ]
        },
        {
            ...
            request: {
                method: "PUT",
                header: [],
                url: {raw: "{{base_url}}/api/orders/{{test_order_id}}/cancel", host: ["{{base_url}}"], path: ["api", "orders", "{{test_order_id}}", "cancel"]}
            },
            event: [
                {listen: "prerequest", script: {type: "text/javascript", exec: getPreconditionScript("cancel_order")}},
                {listen: "test", script: {type: "text/javascript", exec: testScript}}
            ]
        },
        {
            ...
            request: {
                ...
                body: {mode: "raw", raw: "{}"},
                url: {raw: "{{base_url}}/api/admin/orders/{{test_order_id}}/status", host: ["{{base_url}}"], path: ["api", "admin", "orders", "{{test_order_id}}", "status"]}
            },
            event: [
                {listen: "prerequest", script: {type: "text/javascript", exec: getPreconditionScript("admin_update_status")}},
                {listen: "test", script: {type: "text/javascript", exec: testScript}}
            ]
        },
        {
            ...
            event: [
                {listen: "prerequest", script: {type: "text/javascript", exec: getPreconditionScript("admin_get_orders")}},
                {listen: "test", script: {type: "text/javascript", exec: testScript}}
            ]
        }
    ]
...
console.log("Successfully generated eshop_collection_orders.json");
